...
function createElement(name, atNumber, type, color)
	...
	eI.name = name
	eI.type = type
	eI.icon = "__Mobile_Factory__/graphics/elements/" .. name .. ".png"
	eI.icon_size = 89
...
function createRecipe(name, ingredients, results, subgroup)
	...
	eR.name = name
	eR.type = "recipe"
	eR.icon = "__Mobile_Factory__/graphics/e-technology/" .. name .. ".png"
	eR.icon_size = 89
...
function createTechnology(name, unit, prerequisites, unlock)
	...
	eT.name = name
	eT.type = "technology"
	eT.icon = "__Mobile_Factory__/graphics/e-technology/" .. name .. ".png"
	eT.icon_size = 89
