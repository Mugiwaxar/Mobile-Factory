...
qI.type = "item"
qI.stack_size = 50
qI.icon = "__Mobile_Factory_Graphics__/graphics/icons/Quatron.png"
qI.icon_size = 32
...
qcR.type = "recipe"
qcR.icon = "__Mobile_Factory_Graphics__/graphics/icons/Quatron.png"
qcR.icon_size = 32
...
function createQuatronTechnology()
	...
	qT.name = "Quatron"
	qT.type = "technology"
	qT.icon = "__Mobile_Factory_Graphics__/graphics/icons/Quatron.png"
	qT.icon_size = 32
