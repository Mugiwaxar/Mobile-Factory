...
function PDP:update(event)
	...
	for k, entity in pairs(entities) do
		...
		if entity.type ~= "character" and entity.name ~= "PowerDrainPole" and entity.name ~= "OreCleaner" and entity.name ~= "FluidExtractor" and entity.energy > 0 and Util.canUse(self.player, entity) then
